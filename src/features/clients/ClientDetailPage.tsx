    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-6">
        <div className="bg-white border border-slate-200 rounded-xl p-4 text-center">
          <p className="text-2xl font-semibold text-slate-900">{clientCases.length}</p>
          <p className="text-xs text-slate-500 mt-1">Total expedientes</p>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4 text-center">
          <p className="text-2xl font-semibold text-slate-900">{activeCases.length}</p>
          <p className="text-xs text-slate-500 mt-1">Activos</p>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4 text-center">
          <p className="text-2xl font-semibold text-slate-900">{closedCases.length}</p>
              ...
              <div className="space-y-2">
                {clientCases.map((c) => (
                  <div
                    ...
                    className="flex items-center justify-between p-3 rounded-lg border border-slate-200 hover:bg-slate-50 cursor-pointer transition-colors active:bg-slate-100"
                  >
                    <div className="min-w-0">
