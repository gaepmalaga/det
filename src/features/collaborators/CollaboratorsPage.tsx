        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="border-t border-slate-100 pt-4">
              <p className="text-xs font-medium text-slate-700 mb-3">Datos de contacto</p>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-medium text-slate-700 mb-1.5">
              ...
              >
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div className="min-w-0">
                    <p className="font-medium text-slate-900 truncate">{c.legalName}</p>
                    {c.tradeName && (
                      <p className="text-xs text-slate-500 truncate">{c.tradeName}</p>
                    )}
                  </div>
                ...
                {filtered.map((c) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      <p className="font-medium text-slate-900">{c.legalName}</p>
                      {c.tradeName && (
