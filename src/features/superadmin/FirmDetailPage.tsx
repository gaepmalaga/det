...
const STATUS_CONFIG = {
  ...
  cancelled: { label: 'Cancelado', bg: 'bg-muted', border: 'border-border', text: 'text-muted-foreground' },
}
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            {firm.tradeName && (
              <p className="text-sm text-muted-foreground">{firm.tradeName}</p>
            )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-card border border-border rounded-xl overflow-hidden shadow-sm">
            ...
            {members.length === 0 ? (
              <p className="px-5 py-4 text-sm text-muted-foreground">Sin miembros.</p>
            ) : (
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground font-mono">{firm.rnsp}</p>
              </div>
              <div>
                <p className="text-xs text-muted-foreground">TIP titular</p>
          ...
          <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
            ...
            <select
              ...
              disabled={updating}
              className="w-full px-3 py-2 text-sm border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 bg-card disabled:opacity-50 capitalize"
            >
              {PLANS.map((plan) => (
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 text-sm font-medium text-foreground bg-card border border-border rounded-lg hover:bg-muted transition-colors"
                  >
                    Cancelar
                  </button>
                  <button
                    ...
                    disabled={updating}
                    className="flex-1 px-3 py-2 text-sm font-medium text-primary-foreground bg-primary rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50"
                  >
